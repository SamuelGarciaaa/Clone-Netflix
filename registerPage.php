...
<main class="d-flex justify-content-center">
    ...
    <div class="rounded text-white mb-5 login-container">
        <p class="h1 fw-bold fs-2">Sign In</p>
        ...
        <form action="/src/controller/registerController.php" method="POST">
            ...
            <!-- Buttons -->
            <div class="mt-2">
                <input type="submit" value="Sign In" class="rounded py-2 custom-button-1">
            </div>

            <p class="text-center mt-3 custom-p-button">OR</p>

            <div class="mt-2 mb-3">
                <input type="submit" value="Use a Sign-In Code" class="rounded py-2 custom-button-2">
            </div>
            ...
            <div class="checkbox mt-3 mb-3">
                <input class="custom-checkbox" type="checkbox" id="remember-me-checkbox" name="remember-me-checkbox" value="remember" checked>
